...
--            total_cost_type_2 := total_cost_type_2 + current_cost_type_2 / current_step;
        ...
        select to_char(total_cost_type_1, '999999999999999999999.9') into test_text;
...
--        return next total_cost_type_1 + total_cost_type_2;
        return total_cost_type_1 + total_cost_type_2;
    END;
    $$ LANGUAGE plpgsql;
...
--        RAISE notice '% total_cost_length_2 = %', tbl_name, total_cost_length_2;        
        ...
        return total_cost_length_1 + total_cost_length_2;
    END;
    $$ LANGUAGE plpgsql;
