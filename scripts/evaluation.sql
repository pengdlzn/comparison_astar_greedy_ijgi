-- DROP TABLE IF EXISTS compute_cost_type_change(tbl_name text);
...
--      RAISE NOTICE 'current_face_row = %', current_face_row.feature_class; 
      ...
      LOOP        
        ...
        from class_comp_matrix
        where code_from = aggregated_face_row.feature_class 
          and code_to = current_face_row.feature_class;
        ...
        LOOP
          IF ST_Contains(aggregated_face_row.geometry, start_face_row.geometry) THEN
            ...
            from class_comp_matrix
            where code_from = start_face_row.feature_class 
              and code_to = aggregated_face_row.feature_class;            
